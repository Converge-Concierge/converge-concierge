...
export class MemStorage implements IStorage {
  ...
  async createDeliverableRegistrant(data: InsertAgreementDeliverableRegistrant): Promise<AgreementDeliverableRegistrant> { return { id: randomUUID(), ...data, firstName: data.firstName ?? null, lastName: data.lastName ?? null, title: data.title ?? null, email: data.email ?? null, attendeeId: data.attendeeId ?? null, conciergeRole: data.conciergeRole ?? null, registrationStatus: data.registrationStatus ?? "Unknown", createdAt: new Date(), updatedAt: new Date() }; }
  async updateDeliverableRegistrant(_id: string, _data: Partial<InsertAgreementDeliverableRegistrant>): Promise<AgreementDeliverableRegistrant> { return { id: _id, agreementDeliverableId: "", name: "", firstName: null, lastName: null, title: null, email: null, attendeeId: null, conciergeRole: null, registrationStatus: "Unknown", createdAt: new Date(), updatedAt: new Date() }; }
  ...
  async createDeliverableSpeaker(data: InsertAgreementDeliverableSpeaker): Promise<AgreementDeliverableSpeaker> { return { id: randomUUID(), ...data, speakerTitle: data.speakerTitle ?? null, speakerBio: data.speakerBio ?? null, sessionType: data.sessionType ?? null, sessionTitle: data.sessionTitle ?? null, headshotFileAssetId: data.headshotFileAssetId ?? null, createdAt: new Date(), updatedAt: new Date() }; }
  async updateDeliverableSpeaker(_id: string, _data: Partial<InsertAgreementDeliverableSpeaker>): Promise<AgreementDeliverableSpeaker> { return { id: _id, agreementDeliverableId: "", speakerName: "", speakerTitle: null, speakerBio: null, sessionType: null, sessionTitle: null, headshotFileAssetId: null, createdAt: new Date(), updatedAt: new Date() }; }
